...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddCalendarButton = (Button) findViewById(R.id.addcalendar);
        mAddEventButton = (Button) findViewById(R.id.addevent);
        mGetEventButton = (Button) findViewById(R.id.addgetevent);

        mStatusText = (TextView) findViewById(R.id.one);
        mResultText = (TextView) findViewById(R.id.two);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private String addEvent() {
            ...
            calander.add(java.util.Calendar.DAY_OF_WEEK,1);
